'use strict';
/**
 * Test runner utility for Precourse.
 *
 ...
 * - All tests: `npm test`
 * - Single test directory: `npm test questions/strings/`
 * - Single test file: `npm test questions/strings/tests/isPalindrome.test.js`
 *
 */
...
const MANIFEST_FILE_PATH = './questions/manifest.js';
